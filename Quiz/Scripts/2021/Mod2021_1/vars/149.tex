...
\begin{document}
{04.11.2021 Модульна контрольна \No 1, варіант  \No \textbf { 149 }\par}
{
\begin {large}
...
Написати функцiю f, що отримує 3 числа і повертає ознаку того, що вони попарно рiзнi. Стиль запису умови також оцінюється.\par
\newpage
