...
\begin{document}
{04.11.2021 Модульна контрольна \No 1, варіант  \No \textbf { 123 }\par}
{
\begin {large}
...
Написати функцiю f, що отримує число і повертає ознаку того, що воно належить iнтервалу (2016; 2017). Стиль запису умови також оцінюється.\par
\newpage
