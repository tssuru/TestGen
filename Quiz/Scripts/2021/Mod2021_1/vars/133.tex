...
\begin{document}
{04.11.2021 Модульна контрольна \No 1, варіант  \No \textbf { 133 }\par}
{
\begin {large}
...
Написати функцiю f, що отримує 2 числа і повертає ознаку того, що перше число безпечно дiлити на друге. Стиль запису умови також оцінюється.\par
\newpage
