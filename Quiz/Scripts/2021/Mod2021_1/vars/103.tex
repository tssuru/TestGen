...
\begin{document}
{04.11.2021 Модульна контрольна \No 1, варіант  \No \textbf { 103 }\par}
{
\begin {large}
...
Написати функцiю f, що отримує рядок i повертає ознаку того, що вiн складається рівно з однієї літери, яка є двійковою цифрою. Стиль запису умови також оцінюється.\par
\newpage
