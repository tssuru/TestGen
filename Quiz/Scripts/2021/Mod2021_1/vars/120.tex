...
\begin{document}
{04.11.2021 Модульна контрольна \No 1, варіант  \No \textbf { 120 }\par}
{
\begin {large}
...
Написати функцiю f, що отримує число і повертає ознаку того, що воно не належить iнтервалу (2020; 2021). Стиль запису умови також оцінюється.\par
\newpage
