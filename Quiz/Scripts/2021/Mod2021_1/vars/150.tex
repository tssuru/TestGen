...
\begin{document}
{04.11.2021 Модульна контрольна \No 1, варіант  \No \textbf { 150 }\par}
{
\begin {large}
...
Написати функцiю f, що отримує 3 числа i повертає ознаку того, що вони попарно рiвнi. Стиль запису умови також оцінюється.\par
\newpage
