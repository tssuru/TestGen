...
\begin{document}
{04.11.2021 Модульна контрольна \No 1, варіант  \No \textbf { 100 }\par}
{
\begin {large}
...
Написати функцiю f, що отримує 2 числа і повертає ознаку того, що перше число менше за куб другого. Стиль запису умови також оцінюється.\par
\newpage
