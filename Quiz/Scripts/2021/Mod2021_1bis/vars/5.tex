...
\begin{document}
{XX.11.2021 Модульна контрольна \No 1-bis, варіант  \No \textbf { 5 }\par}
{
\begin {large}
...
Написати функцiю f, що отримує 3 числа i повертає ознаку того, що серед них є рівно два рівних. Стиль запису умови також оцінюється.\par
\newpage
