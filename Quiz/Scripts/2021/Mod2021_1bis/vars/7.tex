...
\begin{document}
{XX.11.2021 Модульна контрольна \No 1-bis, варіант  \No \textbf { 7 }\par}
{
\begin {large}
...
Написати функцiю f, що отримує 2 числа і повертає ознаку того, що вони відрізняються якнайменш на 10. Стиль запису умови також оцінюється.\par
\newpage
