...
\begin{document}
{XX.11.2021 Модульна контрольна \No 1-bis, варіант  \No \textbf { 3 }\par}
{
\begin {large}
...
Написати функцiю f, що отримує 2 числа і повертає ознаку того, що одне з них на 1 більше іншого. Стиль запису умови також оцінюється.\par
\newpage
