...
\begin{document}
{XX.11.2021 Модульна контрольна \No 1-bis, варіант  \No \textbf { 6 }\par}
{
\begin {large}
...
Написати функцiю f, що отримує число і повертає ознаку того, що воно дійсного типу. Стиль запису умови також оцінюється.\par
\newpage
