...
Записати ВИРАЗ, значенням якого є словник, ключами якого є цілі числа від 15 до 2006 (включно), що діляться на 2, а ключам відповідають їх квадратні корені\par
\newpage
...
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-61$ до~$35$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$-9$.
Яке значення зберігається у вузлі \kw{p.prev.next.prev.next.prev} ?\par
\newpage
