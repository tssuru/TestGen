...
Написати функцію, що для інтервалу $[a, b)$ знаходить число з найбільшою кількістю різних простих дільників, що містять цифру 7 у своєму десятковому запису. Якщо їх кілька, то цікавить найменше.
