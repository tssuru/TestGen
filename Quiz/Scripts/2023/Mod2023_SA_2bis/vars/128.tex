...
Написати функцію, що повертає довжину найдовшого відрізку послідовності, що складається з чисел, у сімковому запису якого нема цифри 2. За відсутності має повертати $0$. Використовувати додаткові структури даних (у тому числі рядки) заборонено.
