...
Написати функцію, що знаходить друге за абсолютною величиною число з списку цілих, у десятковому запису якого є цифра 5 або цифра 3. Повертає індекс останнього входження цього числа або $-1$ (за відсутності). Використовувати додаткові структури даних (у тому числі рядки) заборонено.
