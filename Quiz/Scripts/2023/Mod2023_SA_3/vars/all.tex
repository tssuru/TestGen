...
\def\code#1{\Verb!#1!}
\begin{document}
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 100 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
...
\vspace{-4mm}
Записати ВИРАЗ, значенням якого є словник, ключами якого є цілі числа від 13 до 2004 (включно), що діляться на 7, а ключам відповідають їх квадрати\par

\vspace{10mm}
               
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-44$ до~$33$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$-5$.
...
В усіх випадках розміри файлів такі, що їх вміст повністю завантажений у пам'ть бути не може. Якість коду також оцінюється.
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 101 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-19$ до~$50$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$-1$.
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 102 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-24$ до~$34$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$6$.
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 103 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-53$ до~$16$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$3$.
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 104 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {4}\end{center}}
\vspace{-4mm}
Записати ВИРАЗ, значенням якого є словник, ключами якого є цілі числа від 16 до 2018 (включно), що не діляться на 2, а ключам відповідають їх куби\par

\vspace{10mm}
               
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-39$ до~$18$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$0$.
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 105 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
\vspace{-4mm}
 ...
 Задано числову послідовність \kw{s} довжини 6000. Записати ВИРАЗ, значенням якого є список, що складається з елементів послідовності, що не діляться на 13, записаних в обернено\-му порядку.\par

\vspace{10mm}
               
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-52$ до~$36$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$-9$.
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 106 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-21$ до~$38$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$1$.
Яке число зберігається у вузлі \kw{p.next.next.prev.next.prev} ?\par
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 107 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
Записати ВИРАЗ, значенням якого є список, що складається з цілих чисел від 16 до 2000 (включно), причому спочатку за зростанням записано всі, що діляться на 5, а потім решту за спаданням.\par

\vspace{10mm}
               
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-59$ до~$17$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$8$.
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 108 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-37$ до~$48$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$-2$.
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 109 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 110 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
Записати ВИРАЗ, значенням якого є список, що складається з кубів цілих чисел від 13 до 2001 (включно), що діляться на 2, записаних в обернено\-му порядку.\par

\vspace{10mm}
               
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-35$ до~$31$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$4$.
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 111 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-50$ до~$23$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$-6$.
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 112 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-25$ до~$21$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$-3$.
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 113 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
Записати ВИРАЗ, значенням якого є список, що складається з цілих чисел від 17 до 2016 (включно), причому спочатку за спаданням записано всі, що не діляться на 3, а потім решту за зростанням.\par

\vspace{10mm}
               
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-63$ до~$40$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$9$.
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 114 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-42$ до~$26$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$2$.
Яке число зберігається у вузлі \kw{p.prev.prev.next.prev.next} ?\par
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 115 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-49$ до~$37$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$-4$.
Яке число зберігається у вузлі \kw{p.next.next.prev.next.prev} ?\par
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 116 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-70$ до~$45$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$-8$.
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 117 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-62$ до~$42$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$5$.
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 118 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {4}\end{center}}
\vspace{-4mm}
Задано словник \kw{d} з цілими ключами та значеннями. Записати ВИРАЗ, значенням якого є множина, що складається  з тих значень, чиї ключі невід'єм\-ні.\par

\vspace{10mm}
               
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-45$ до~$29$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$7$.
Яке число зберігається у вузлі \kw{p.next.next.next.next.prev} ?\par
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 119 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-38$ до~$44$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$6$.
Яке число зберігається у вузлі \kw{p.prev.prev.prev.prev.next} ?\par
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 120 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-22$ до~$47$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$5$.
Яке число зберігається у вузлі \kw{p.next.next.prev.prev.next} ?\par
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 121 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-66$ до~$32$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$2$.
Яке число зберігається у вузлі \kw{p.prev.prev.next.next.prev} ?\par
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 122 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-48$ до~$30$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$-4$.
Яке число зберігається у вузлі \kw{p.next.prev.prev.next.prev} ?\par
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 123 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-28$ до~$20$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$0$.
Яке число зберігається у вузлі \kw{p.prev.next.next.prev.next} ?\par
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 124 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-57$ до~$22$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$-6$.
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 125 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
Записати ВИРАЗ, значенням якого є список, що складається з квадратів цілих чисел від 12 до 2010 (включно), що не діляться на 7.\par

\vspace{10mm}
               
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-43$ до~$25$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$8$.
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 126 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-29$ до~$19$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$7$.
Яке число зберігається у вузлі \kw{p.prev.prev.next.prev.next} ?\par
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 127 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-40$ до~$46$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$3$.
Яке число зберігається у вузлі \kw{p.next.next.prev.next.prev} ?\par
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 128 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-68$ до~$28$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$-9$.
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 129 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-18$ до~$39$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$9$.
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 130 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-17$ до~$43$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$-3$.
...
{{16.05.2024 Контрольна робота, варіант  \No \textbf { 131 }} група К12 ПІБ {\parbox {2.5 cm} \dotfill}\par}
{
%\begin {large}
\begin{minipage}[t]{9.7cm}
...
{\begin{center}Завдання {4}\end{center}}
\vspace{-4mm}
Записати ВИРАЗ, значенням якого є словник, ключами якого є цілі числа від 14 до 2005 (включно), що не діляться на жодне з чисел 2, 3, а ключам відповідають їх квадратні корені\par

\vspace{10mm}
               
{\begin{center}Завдання {5}\end{center}}
\vspace{-4mm}
Змінні \kw{next} та \kw{prev} вузла списку позначають наступний та попередній за ним вузол відповідно. Починаючи з голови, у список записано послідовні цілі числа від~$-30$ до~$27$. Нехай змінна \kw{p} позначає вузол, що зберігає значення~$1$.
